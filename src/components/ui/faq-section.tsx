...
export default function FAQWithSpiral() {
  ...
  const faqs = [
    {
      q: "What IT consulting services do you offer?",
      a: "We provide comprehensive IT consulting services including digital transformation, cloud migration, system architecture design, DevOps implementation, security audits, technology strategy, custom software development, and legacy system modernization.",
    },
    {
      q: "What industries do you specialize in?",
      a: "We work across multiple industries including healthcare, finance, e-commerce, manufacturing, and technology. Our team adapts to industry-specific requirements and compliance standards.",
    },
    {
      q: "How do you approach digital transformation projects?",
      a: "We start with a comprehensive assessment of your current systems and processes. Then we develop a phased roadmap, prioritize quick wins, and ensure minimal business disruption while implementing modern solutions that scale with your growth.",
    },
    {
      q: "Do you provide cloud migration services?",
      a: "Yes. We help businesses migrate to AWS, Azure, and Google Cloud. Our approach includes assessment, planning, migration strategy, execution, and post-migration optimization with zero-downtime methodologies.",
    },
    {
      q: "What is your team size and structure?",
      a: "We have a scalable team of senior consultants, architects, developers, and DevOps engineers. We assemble project-specific teams based on your needs, ensuring the right expertise for each engagement.",
    },
    {
      q: "How do you handle data security and compliance?",
      a: "Security is built into every solution. We follow industry best practices, conduct regular security audits, ensure GDPR/HIPAA/SOC 2 compliance where needed, and implement encryption, access controls, and monitoring systems.",
    },
    {
      q: "What is your pricing model?",
      a: "We offer flexible pricing models: fixed-price for well-defined projects, time-and-materials for agile engagements, and retainer-based for ongoing support. We provide transparent estimates and regular budget updates.",
    },
    {
      q: "How long does a typical consulting engagement last?",
      a: "Engagements vary from 2-4 weeks for assessments and audits, to 3-6 months for implementation projects, to ongoing relationships for managed services. Timeline depends on project scope and complexity.",
    },
    {
      q: "Do you offer 24/7 support and maintenance?",
      a: "Yes. We provide tiered support packages including business hours, extended hours, and 24/7 monitoring with defined SLAs. We also offer proactive maintenance and continuous improvement services.",
    },
    {
      q: "Can you work with our existing IT team?",
      a: "Absolutely. We excel at collaborating with internal teams, providing knowledge transfer, training, and documentation. We complement your team's expertise and help build internal capabilities.",
    },
    {
      q: "What technologies and tools do you specialize in?",
      a: "TypeScript/React/Next.js, Node.js, Python, Java, .NET, Postgres, MongoDB, Redis, Docker, Kubernetes, AWS, Azure, Terraform, CI/CD pipelines, microservices architecture, and modern DevOps practices.",
    },
    {
      q: "How do you ensure project success?",
      a: "We use agile methodologies, regular communication, milestone-based deliveries, continuous testing, and transparent reporting. Each project has a dedicated project manager and follows our proven framework for success.",
    },
    {
      q: "Do you provide post-implementation support?",
      a: "Yes. We offer comprehensive post-launch support including bug fixes, performance optimization, feature enhancements, system monitoring, and ongoing maintenance packages tailored to your needs.",
    },
    {
      q: "What makes you different from other IT consultancies?",
      a: "We combine deep technical expertise with business acumen, focus on delivering measurable ROI, maintain transparent communication, use cutting-edge technologies, and build long-term partnerships rather than one-off projects.",
    },
    {
      q: "Can you help with legacy system modernization?",
      a: "Yes. We specialize in modernizing legacy systems through strategic replatforming, refactoring, or gradual migration. We assess risks, minimize downtime, and ensure business continuity throughout the process.",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-5xl px-6 pt-32 pb-16">
        {/* Header */}
        <header className="mb-10 flex items-end justify-between pb-6">
          <div>
            <h1 className="text-4xl md:text-6xl font-black tracking-tight text-white">FAQ</h1>
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              className="h-10 w-56 rounded-xl border border-white/20 bg-transparent px-3 text-sm text-white placeholder:text-white/50 outline-none transition focus:border-white/60"
            />
          </div>
        </header>
          ...
          <div className="space-y-3 text-xs">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="rounded-xl border border-white/20 px-3 py-2 text-xs text-white hover:border-white/50"
              >
                Close (H)
              </button>
            </div>

    ...
    <section ref={ref} className="py-32 bg-gradient-to-b from-white to-background relative overflow-hidden">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <button className="group relative inline-flex items-center h-14 px-6 bg-[#2639ED] text-white rounded-2xl overflow-hidden transition-all duration-300 text-button">
